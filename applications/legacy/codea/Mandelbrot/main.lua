...
function setup() 
    ...
    log("This program plots an image of the Mandelbrot set using the image() class.\n")
    log("Tap anywhere in the window to zoom in, double-tap to zoom out.\n")
    log("ManCalcTime is the time it takes to calculate the set membership and escape values.\n")
    log("Parameter: RMode sets the type of color map the set is rendered with.\n")
    log("Parameter: Resolution sets the level of image detail.")
    log("Higher resolutions make prettier pictures at the expense of slower update.")
